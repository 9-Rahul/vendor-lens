      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {appState === "upload" && (
          <div className="max-w-4xl mx-auto p-8 lg:p-16">
            <h1 className="text-[24px] sm:text-[32px] font-extrabold tracking-tight text-[var(--color-on-surface)] mb-2">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="w-full sm:w-auto bg-[var(--color-primary-container)] disabled:opacity-50 disabled:cursor-not-allowed text-white px-6 py-2.5 rounded-md font-medium text-[13px] flex items-center justify-center gap-2 hover:bg-[var(--color-brand-hover)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--color-primary-container)]"
              >
                Run Analysis
              </button>
            </div>
        ...
        {appState === "results" && assessmentData && selectedReq && (
          <div className="max-w-[1200px] mx-auto p-4 sm:p-6 md:p-10">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 pb-6 border-b border-[var(--color-outline-variant)]/30">
              <div>
                <h1 className="text-[20px] sm:text-[24px] font-bold tracking-tight text-[var(--color-on-surface)] mb-1">
              ...
              <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                <button
                  onClick={resetApp}
                  className="flex items-center gap-2 px-3 sm:px-4 py-2 border border-[var(--color-outline-variant)] rounded-md text-[12px] font-medium hover:bg-[var(--color-surface-container-lowest)] transition-colors whitespace-nowrap"
                >
                  <LuArrowLeft className="w-4 h-4" />
                  <span className="hidden sm:inline">Analyze Another Vendor</span>
                </button>
                <button 
                  onClick={() => exportMutation.mutate()}
                  disabled={exportMutation.isPending}
                  className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-[var(--color-primary-container)] disabled:opacity-50 text-white rounded-md text-[12px] font-medium hover:bg-[var(--color-brand-hover)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--color-primary-container)] whitespace-nowrap"
                >
                  {exportMutation.isPending ? <LuLoader className="w-4 h-4 animate-spin" /> : <LuDownload className="w-4 h-4" />}
                  {exportMutation.isPending ? "Exporting..." : <span className="hidden sm:inline">Export Assessment</span>}
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="w-full lg:w-2/3 bg-[var(--color-surface-container-low)] rounded-xl p-4 sm:p-6 border border-[var(--color-outline-variant)]/30 flex flex-col lg:flex-row gap-6">
